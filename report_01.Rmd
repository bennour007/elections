...
Now that I am more comfortable in the pythonic world of dunamism and ease, *THE COMMUNITY REALLY NEEDS TO FIND A WAY TO MIMIC RMD*. while this entire websire is written in Rmd with Rstudio, I haven't come cross any reporting tool as elegant, and pertinent as Rmd and the knitr package in R. 
...
```{python include=FALSE}
dirs = glob.glob('/home/bennour/Projects/elections/super_final_data/*.csv')
```


```{python include=FALSE}
fnames = os.listdir('/home/bennour/Projects/elections/super_final_data')
